...
dev:
	...
	@echo "Building native image and starting application..."
	@mvn -Pnative -DskipTests clean install > .dev.log 2>&1 && mvn -Pnative -DskipTests spring-boot:run >> .dev.log 2>&1 &
