...
public class UserFacade {
    ...
    // Credentials are persisted in the DB; in-memory map removed.
    ...
    public UserFacade(PasswordEncoder passwordEncoder, UserProfileRepository profileRepo, UserCredentialRepository credentialRepo, ApiKeyRepository apiKeyRepo, UserRoleRepository roleRepo) {
